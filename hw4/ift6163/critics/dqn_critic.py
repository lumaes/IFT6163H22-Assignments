...
class DQNCritic(BaseCritic):
    ...
    def update(self, ob_no, ac_na, next_ob_no, reward_n, terminal_n):
        ...
        if self.double_q:
            ...
            #TODO Rt+1+γQ(St+1, argmax Q(St+1, a; θt), θ−t)
            q_next_values = self.q_net(next_ob_no)
            actions = q_next_values.argmax(dim=1)
            # pick on qa_tp1_values the actions that the q_net predict
