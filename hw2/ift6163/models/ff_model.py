...
class FFModel(nn.Module, BaseModel):
    ...
    def forward(
        ...
        self.update_statistics(obs_mean,
                               obs_std,
                               acs_mean,
                               acs_std,
                               delta_mean,
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        """
        # DONE get numpy array of the predicted next-states (s_t+1)
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        # Compute loss
        # NOTE: prediction here is the normalized_delta and not the next state !
        _, prediction = self(observations,
                            actions,
                            data_statistics['obs_mean'],
                            data_statistics['obs_std'],
                            data_statistics['acs_mean'],
